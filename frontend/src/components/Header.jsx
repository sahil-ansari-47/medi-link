    ...
    <>
      ...
      <header className="sticky top-0 flex justify-between items-center p-4 bg-primary shadow-md z-20 w-full">
        ...
        <div className="relative profile-dropdown" ref={dropdownRef}>
          ...
          {dropdownOpen && <DropdownMenu logout={logout} />}
        </div>
      </header>
        ...
        <div className="p-4 bg-primary font-bold flex flex-col items-center">
          ...
          {user.phone_number != null ? (
            ...
            <div className="flex flex-col items-center">
              ...
              <button
                className="bg-emerald-200 rounded-lg p-2 m-4 text-emerald-800 cursor-pointer "
                onClick={() => {
                  toggleMenu();
                  navigate("/register");
                }}
  ...
  return (
    <div className="absolute right-0 mt-2 w-48 bg-white border rounded shadow z-50">
      <ul className="text-sm">
        ...
        <li
          className="px-4 py-2 hover:bg-gray-100 hover:text-red-400 cursor-pointer"
          onClick={logout}
        >
          Logout
        </li>
